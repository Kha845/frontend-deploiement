...
const [lastInitiale, setLastInitiale] = useState<{
  ...
  useEffect(() => {
    const fetchLastRecord = async () => {
        const lastRecord = await senStockStore.getDataLastRecord();
  ...
  const { getDataLastInputStockIndustriel, getDataLastInputStockCommercial , getDataLastOutputStock} = senStockStore;
        ...
        <CardContent sx={{ padding: 3 }}>
          ...
          <Box display="flex" flexDirection="column" alignItems="left" width="100%">
            <Box display="flex" justifyContent="space-between" width="100%" mb={1}>
              ...
              <Typography fontWeight="bold" sx={{ fontSize: '1.1rem' }}>Stockeur: Senstock</Typography>
            </Box>
