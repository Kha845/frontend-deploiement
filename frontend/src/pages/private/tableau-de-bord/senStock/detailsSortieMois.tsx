...
const DetailsSortieMois = () => {
  ...
  const initTable = async () => {
    try {
      ...
      const data = await senStockStore.getDataLastMonthOutputStock();
  ...
  return (
    ...
    >
      ...
      <Typography variant="h4" textAlign="center" gutterBottom color="success" marginLeft='9%'>
        TABLEAU DES SORTIES DE CARBURANTS  DE SENSTOCK POUR LE MOIS {month}
      </Typography>
      <Box
        sx={{
          display: 'flex',
...
export default DetailsSortieMois;
