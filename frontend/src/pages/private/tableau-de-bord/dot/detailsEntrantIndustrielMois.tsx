...
const DetailsEntrantIndustrielMoisDOT = () => {
  ...
  const initTable = async () => {
    try {
      ...
      const data = await dotStore.getDataLastMonthInputStockIndustriel();
  ...
  return (
    ...
    >
      ...
      <Typography variant="h4" textAlign="center" gutterBottom color="success" marginLeft='12%'>
        TABLEAU DES ENTREES DE CARBURANTS EN FORMAT INDUSTRIEL DE DOT POUR LE MOIS {month}
      </Typography>
      <Box
        sx={{
          display: 'flex',
...
export default DetailsEntrantIndustrielMoisDOT;
