...
const DetailsEntrantCommercialMoisDOT = () => {
  ...
  const initTable = async () => {
    try {
      ...
      const data = await dotStore.getDataLastMonthInputStockCommercial();
...
useEffect(() => {
  ...
  return (
    ...
    >
      ...
      TABLEAU DES ENTREES DE CARBURANTS EN FORMAT COMMERCIAL DE DOT POUR LE MOIS {month}
      </Typography>
      <Box
        sx={{
          display: 'flex',
...
export default DetailsEntrantCommercialMoisDOT;
